...
- [branches.ts](file:///Users/suns/Downloads/OutSource/HungTin/backend/src/routes/branches.ts): Chuyển đổi API chi nhánh.
...
- [Login.tsx](file:///Users/suns/Downloads/OutSource/HungTin/frontend/src/pages/Login.tsx): Quy trình 2 bước đăng nhập (Pre-check token -> Auth login).
- [Employees.tsx](file:///Users/suns/Downloads/OutSource/HungTin/frontend/src/pages/Employees.tsx): Cập nhật bảng nhân viên, badge `Tạm khóa (sai pass)` và reset pass unlock.
- [Contracts.tsx](file:///Users/suns/Downloads/OutSource/HungTin/frontend/src/pages/Contracts.tsx), [PawnDetail.tsx](file:///Users/suns/Downloads/OutSource/HungTin/frontend/src/pages/PawnDetail.tsx): Giao diện quản lý hợp đồng & chi tiết cầm đồ.
