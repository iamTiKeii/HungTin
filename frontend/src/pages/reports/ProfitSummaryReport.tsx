      ...
      {data && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">Tiền Giải Ngân Mới</p>
            <h2 className="text-2xl font-black text-slate-100 mt-2">{formatCurrency(getSubTotal("disbursed"))}</h2>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">Tổng Dư Nợ Hiện Tại</p>
            <h2 className="text-2xl font-black text-slate-100 mt-2">{formatCurrency(getSubTotal("outstanding"))}</h2>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">Tiền Lãi Đã Thu</p>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 backdrop-blur-md relative overflow-hidden group">
            ...
            <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">Khách Hàng Nợ Lại</p>
        ...
        {loading || !data ? (
          ...
          <div className="overflow-x-auto">
            <table className="table w-full text-slate-300">
              <thead>
                <tr className="border-b border-slate-800/60 text-slate-400 text-xs">
                  <th>Loại Hình</th>
                  <th>Tổng Số HĐ</th>
                  <th>HĐ Mới</th>
                  <th>HĐ Cũ</th>
              ...
              <tbody className="text-xs">
                ...
                <tr className="border-b border-slate-800/40 hover:bg-slate-900/20">
                  <td className="font-bold text-amber-400">Cầm đồ</td>
