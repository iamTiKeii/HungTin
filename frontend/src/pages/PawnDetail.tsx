    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
          <p className="text-xs text-slate-400 font-semibold uppercase">Số tiền vay gốc ban đầu</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
          <p className="text-xs text-slate-400 font-semibold uppercase">Nợ cũ còn tích lũy</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5">
          <p className="text-xs text-slate-400 font-semibold uppercase">Ngày hẹn kế tiếp</p>
          {activeTimer ? (
            <div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        <h2 className="text-sm font-bold text-slate-300 uppercase tracking-wider mb-4">Thao tác nghiệp vụ nhanh</h2>
        ...
        <div className="p-6">
          ...
          {activeSubTab === "principal" && (
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-slate-800/80">
                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Lịch sử gia hạn thời hạn hợp đồng</h3>
          ...
          {activeSubTab === "debt" && (
            <div className="space-y-4">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Nhật ký các khoản nợ phụ cũ phát sinh</h3>
          ...
          {activeSubTab === "ledger" && (
            <div className="space-y-4">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Nhật ký hoạt động kiểm toán hệ thống</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {contract.documents?.map((doc: any) => (
                  <div key={doc.id} className="bg-slate-950/60 border border-slate-850 p-3 rounded-xl flex flex-col justify-between group relative">
            ...
            <div className="space-y-6">
              <form onSubmit={handleAddReminderLog} className="flex gap-3">
                <input
                  ...
                  className="input input-bordered flex-1 bg-slate-950 border-slate-800 text-slate-200 rounded-xl"
                  required
                />
              ...
              <div className="space-y-3">
                {contract.debt_reminders?.map((log: any) => (
                  <div key={log.id} className="p-3 bg-slate-950/40 border border-slate-850 rounded-xl text-xs flex justify-between">
                    <div>
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl">
            ...
            <form onSubmit={handlePayInterest} className="space-y-4">
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Phí phạt trễ / Phí khác (VNĐ)</label>
                <input
                  type="number"
                  placeholder="0"
                  value={payInterestOther}
                  onChange={(e) => setPayInterestOther(e.target.value)}
                  className="input input-bordered w-full bg-slate-955 border-slate-850 text-slate-200 rounded-xl"
                />
              </div>
              <div>
                <label className="label text-slate-400 text-sm py-1">Ghi chú thu lãi</label>
                <textarea
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl">
            ...
            <form onSubmit={handlePrincipalTransaction} className="space-y-4">
              <div>
                <label className="label text-slate-400 text-sm py-1">Loại nghiệp vụ</label>
                <select
                  value={principalAction}
                  onChange={(e: any) => setPrincipalAction(e.target.value)}
                  className="select select-bordered w-full bg-slate-950 border-slate-800 text-slate-200 rounded-xl focus:outline-none"
                >
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Số tiền giao dịch (VNĐ) *</label>
                <input
                  type="number"
                  placeholder="5000000"
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Lý do điều chỉnh dư nợ gốc *</label>
                <textarea
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl">
            ...
            <form onSubmit={handleExtend} className="space-y-4">
              <div>
                <label className="label text-slate-400 text-sm py-1">Số ngày gia hạn thêm (ngày) *</label>
                <input
                  type="number"
                  placeholder="15"
                  value={extendDays}
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Nội dung gia hạn</label>
                <textarea
            ...
            <form onSubmit={handleRedeem} className="space-y-4">
              <div className="bg-slate-950/80 p-4 border border-slate-800 rounded-xl text-xs space-y-2.5">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-slate-200">{formatCurrency(contract.loan_amount)}</span>
                </div>
                <div className="flex justify-between">
                  <span>Nợ phụ còn đọng:</span>
                  <span className="font-bold text-slate-200">{formatCurrency(contract.debt_amount)}</span>
                </div>
                <div className="border-t border-slate-800/80 pt-2.5 flex justify-between text-amber-500 font-black">
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Ngày chuộc thực tế</label>
                <input
                  type="date"
                  value={redeemDate}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="textarea textarea-bordered w-full bg-slate-955 border-slate-850 text-slate-200 rounded-xl h-16"
                />
              </div>
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl">
            ...
            <form onSubmit={handleDebtAction} className="space-y-4">
              <div>
                <label className="label text-slate-400 text-sm py-1">Hình thức nợ</label>
                <select
                  value={debtAction}
                  onChange={(e: any) => setDebtAction(e.target.value)}
                  className="select select-bordered w-full bg-slate-955 border-slate-800 text-slate-200 rounded-xl focus:outline-none"
                >
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Số tiền nợ giao dịch (VNĐ) *</label>
                <input
                  type="number"
                  placeholder="1000000"
                  value={debtAmount}
        ...
        <div className="modal modal-open">
          <div className="modal-box bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl">
            ...
            <form onSubmit={handleSetTimer} className="space-y-4">
              ...
              <div>
                <label className="label text-slate-400 text-sm py-1">Nội dung cuộc hẹn</label>
                <input
                  type="text"
